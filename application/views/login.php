                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-9">
                                        <div>
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="form-horizontal" method="POST" action="<?php echo base_url('user_login');?>">
                    
                                                    <div class="form-group auth-form-group-custom mb-4">
                                                        <i class="ri-user-2-line auti-custom-input-icon"></i>
                                                        <label for="username">Username</label>
                                                        <input type="text" name="email_id" class="form-control" id="username" placeholder="Enter username">
